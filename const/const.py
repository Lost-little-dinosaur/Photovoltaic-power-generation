...
UNIT = 0.001  # 以米为单位
INF = 1000000000  # 无穷大
roofBoardLength = 1  # 打印屋顶示意图时，额外屋顶边缘的宽度
PhotovoltaicPanelBoardLength = 1  # 打印屋顶示意图时，额外屋顶边缘的宽度
...
PhotovoltaicPanelMargin = 6  # 光伏板边缘
Margin = 4  # 边缘
RoofMargin = 5  # 屋顶边缘
ColorDict = {Empty: (1.0, 1.0, 1.0, 1.0), Obstacle: (0.0, 0.0, 0.0, 1.0),
             ...
             PhotovoltaicPanelMargin: (0.43, 0.43, 0.43, 1.0)}
